$(document).ready(function () {
    ...
    function searchingMakeBlocks() {
        $('.index_items.work_items>div').addClass('searching-lg-4 searching-md-6 searching-xs-12 text-center').removeClass('searching_list');
        $('.last_added').removeClass('line');
    }
    function searchingMakeList() {
        $('.index_items.work_items>div').removeClass('searching-lg-4 searching-md-6 searching-xs-12 text-center').addClass('searching_list');
