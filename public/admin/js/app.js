  ...
  $(function(){
    ...
    function activateDropdown(elem) {
      ...
      if ( menu.length ) {
        ...
        if(elem.text().trim() == 'English') {
          toggle.html( '<img src="/img/icons/usa.svg" alt="" id="language_flag" style="width: 20px;"> '+elem.text() );
        }else if(elem.text().trim() == 'Thai') {
          toggle.html( '<img src="/img/icons/thailand.png" alt="" id="language_flag" style="width: 20px;"> '+elem.text() );
        }else if(elem.text().trim() == 'Russian') {
          toggle.html( '<img src="/img/icons/russian.svg" alt="" id="language_flag" style="width: 20px;"> '+elem.text() );
        }
